...
const std::vector<std::string> CAPTIONS_MELEE{ "Knife", "Nightstick", "Hammer", "Baseball Bat", "Golf Club", "Crowbar", "Bottle", "Antique Dagger", "Hatchet", "Knuckle Dusters" ,"Flashlight", "Switchblade", "Machete"};
const std::vector<std::string> VALUES_MELEE{ "WEAPON_KNIFE", "WEAPON_NIGHTSTICK", "WEAPON_HAMMER", "WEAPON_BAT", "WEAPON_GOLFCLUB", "WEAPON_CROWBAR", "WEAPON_BOTTLE", "WEAPON_DAGGER", "WEAPON_HATCHET", "WEAPON_KNUCKLE", "WEAPON_FLASHLIGHT", "WEAPON_SWITCHBLADE", "WEAPON_MACHETE" }; //13
const std::vector<std::string> CAPTIONS_HANDGUN{ "Pistol", "Combat Pistol", "AP Pistol", "Pistol .50", "SNS Pistol", "Heavy Pistol", "Vintage Pistol", "Stun Gun", "Flare Gun", "Marksman's Pistol", "Revolver" };
...
const std::vector<std::string> VALUES_SUBMACHINE{ "WEAPON_MICROSMG", "WEAPON_SMG", "WEAPON_ASSAULTSMG", "WEAPON_MG", "WEAPON_COMBATMG", "WEAPON_GUSENBERG", "WEAPON_COMBATPDW", "WEAPON_MACHINEPISTOL" }; //7
...
const std::vector<std::string> CAPTIONS_ATTACH_KNUCKLE{ "Default", "Pimp", "Ballas", "Dollar", "Diamond", "Hate", "Love", "Player", "King", "Vagos"};
const std::vector<std::string> VALUES_ATTACH_KNUCKLE{ "COMPONENT_KNUCKLE_VARMOD_BASE", "COMPONENT_KNUCKLE_VARMOD_PIMP", "COMPONENT_KNUCKLE_VARMOD_BALLAS", "COMPONENT_KNUCKLE_VARMOD_DOLLAR", "COMPONENT_KNUCKLE_VARMOD_DIAMOND", "COMPONENT_KNUCKLE_VARMOD_HATE", "COMPONENT_KNUCKLE_VARMOD_LOVE", "COMPONENT_KNUCKLE_VARMOD_PLAYER", "COMPONENT_KNUCKLE_VARMOD_KING", "COMPONENT_KNUCKLE_VARMOD_VAGOS"};

const std::vector<std::string> CAPTIONS_ATTACH_REVOLVER{ "VIP", "Bodyguard" };
const std::vector<std::string> VALUES_ATTACH_REVOLVER{ "COMPONENT_REVOLVER_VARMOD_BOSS", "COMPONENT_REVOLVER_VARMOD_GOON"};

const std::vector<std::string> CAPTIONS_ATTACH_SWITCHBLADE{ "Default" ,"VIP", "Bodyguard" };
...
const std::vector<std::string> CAPTIONS_ATTACH_MACHINEPISTOL{ "Default Clip", "Extended Clip", "Suppresor" };
const std::vector<std::string> VALUES_ATTACH_MACHINEPISTOL{ "COMPONENT_MACHINEPISTOL_CLIP_01", "COMPONENT_MACHINEPISTOL_CLIP_02", "COMPONENT_AT_PI_SUPP" };
...
bool onconfirm_weapon_menu(MenuItem<int> choice)
{
	...
	case 0:
		...
		set_status_text("~g~All weapons added");
		break;
	// switchable features
	case 1:
