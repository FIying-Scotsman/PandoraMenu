...
namespace PLAYER
{
	...
	static void SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS(Player player, BOOL p1) { invoke<Void>(0x596976B02B6B5700, player, p1); } // 0x596976B02B6B5700 0xA3D675ED
...
namespace ENTITY
{
	...
	static void _0xF4080490ADC51C6F(Entity entity) { invoke<Void>(0xF4080490ADC51C6F, entity); } // 0xF4080490ADC51C6F 0x6909BA59
...
namespace VEHICLE
{
	...
	static void EXPLODE_VEHICLE(Vehicle vehicle, BOOL isAudible, BOOL isVisible) { invoke<Void>(0xBA71116ADF5B514C, vehicle, isAudible, isVisible); } // 0xBA71116ADF5B514C 0xBEDEACEB
...
namespace AI
{
	...
	static void TASK_VEHICLE_GOTO_NAVMESH(Ped ped, Vehicle vehicle, float x, float y, float z, float speed, int drivingMode, float stoppingRange) { invoke<Void>(0x195AEEB13CEFE2EE, ped, vehicle, x, y, z, speed, drivingMode, stoppingRange); } // 0x195AEEB13CEFE2EE 0x55CF3BCD
...
namespace STATS
{
	...
	static BOOL _STAT_SET_ENUM(Hash statName, char* value, BOOL save) { return invoke<BOOL>(0x17695002FD8B2AE0, statName, value, save); } // 0x17695002FD8B2AE0 0xC1224AA7
...
namespace FIRE
{
	...
	static void ADD_EXPLOSION(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isVisible, float cameraShake) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isVisible, cameraShake); } // 0xE3AD2BDBAEE269AC 0x10AF5258
	static void ADD_OWNED_EXPLOSION(Ped ped, float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isVisible, float cameraShake) { invoke<Void>(0x172AA1B624FA1013, ped, x, y, z, explosionType, damageScale, isAudible, isVisible, cameraShake); } // 0x172AA1B624FA1013 0x27EE0D67
	static void _ADD_SPECFX_EXPLOSION(float x, float y, float z, int explosionType, Hash explosionFx, float damageScale, BOOL isAudible, BOOL isVisible, float cameraShake) { invoke<Void>(0x36DD3FE58B5E5212, x, y, z, explosionType, explosionFx, damageScale, isAudible, isVisible, cameraShake); } // 0x36DD3FE58B5E5212 0xCF358946
...
namespace DECORATOR
{
	static BOOL _SET_DECORATOR_TIME(Entity entity, char* propertyName, int value) { return invoke<BOOL>(0x95AED7B8E39ECAA4, entity, propertyName, value); } // 0x95AED7B8E39ECAA4 0xBBAEEF94
