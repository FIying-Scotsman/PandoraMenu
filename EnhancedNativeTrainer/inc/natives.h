...
namespace VEHICLE
{
	...
	static int GET_VEHICLE_LIVERY_COUNT(int p0) { return invoke<int>(0x87B63E25A529D526, p0); } // 0x87B63E25A529D526 0xFB0CA947
...
namespace GRAPHICS
{
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(char *p0, Any p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, BOOL p9, BOOL p10, BOOL p11) { return invoke<BOOL>(0x0D53A3B8DA0809D2, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0D53A3B8DA0809D2 9604DAD4
